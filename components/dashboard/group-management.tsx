...
import { GroupDetailModal } from "@/components/dashboard/group-detail-modal"
...
export function GroupManagement() {
  ...
  const handleInviteMembers = (groupId: number) => {
    toast({
      title: "Invitation Sent",
      description: "Invitations have been sent to the new members",
    })
  }
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => handleInviteMembers(group.id)}>
      ...
      <GroupDetailModal isOpen={isDetailModalOpen} onClose={() => setIsDetailModalOpen(false)} group={selectedGroup} />
    </motion.div>
  )
}
