...
export function ActivityLogs() {
  ...
  const handleExportCSV = () => {
    toast({
      ...
      description: "Your activity logs are being exported to CSV",
    })
  }
                ...
                {filteredActivities.map((activity, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="grid grid-cols-12 gap-2 p-4 items-center border-b last:border-0 hover:bg-accent/50 transition-colors"
                    >
